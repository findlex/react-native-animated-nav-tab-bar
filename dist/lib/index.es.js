...
import { StyleSheet, Platform, View, Animated, Dimensions, BackHandler, I18nManager } from 'react-native';
...
var TabBarElement = (function (_a) {
    ...
    var topPositioned = Platform.OS === 'ios' ? appearance.topPositioned : undefined;
    ...
    return (React__default.createElement(React__default.Fragment, null,
        ...
        tabBarVisible && (React__default.createElement(View, { pointerEvents: "box-none", style: (floating || topPositioned) && overlayStyle },
            React__default.createElement(BottomTabBarWrapper, { style: tabStyle, floating: floating, topPadding: topPadding, bottomPadding: bottomPadding, horizontalPadding: horizontalPadding, tabBarBackground: tabBarBackground, shadow: shadow, topPositioned: topPositioned, forcedWidth: forcedWidth },
