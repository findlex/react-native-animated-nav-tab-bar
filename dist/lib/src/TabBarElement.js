...
export default (function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        tabBarVisible && (React.createElement(View, { pointerEvents: "box-none", style: (floating || topPositioned) && overlayStyle },
            React.createElement(BottomTabBarWrapper, { style: tabStyle, floating: floating, topPadding: topPadding, bottomPadding: bottomPadding, horizontalPadding: horizontalPadding, tabBarBackground: tabBarBackground, shadow: shadow, topPositioned: topPositioned, forcedWidth: forcedWidth },
