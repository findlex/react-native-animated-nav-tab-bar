...
// Config
var floatingMarginBottom = Styled.css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  margin-bottom: ", "px;\n"], ["\n  margin-bottom: ", "px;\n"])), reactNativeSafeAreaContext.initialWindowMetrics === null || reactNativeSafeAreaContext.initialWindowMetrics === void 0 ? void 0 : reactNativeSafeAreaContext.initialWindowMetrics.insets.bottom);
var floatingMarginTop = Styled.css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  margin-top: ", "px;\n"], ["\n  margin-top: ", "px;\n"])), reactNativeSafeAreaContext.initialWindowMetrics === null || reactNativeSafeAreaContext.initialWindowMetrics === void 0 ? void 0 : reactNativeSafeAreaContext.initialWindowMetrics.insets.top);
var floatingMarginHorizontal = Styled.css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  margin-horizontal: 20px;\n"], ["\n  margin-horizontal: 20px;\n"])));
var floatingRoundCorner = Styled.css(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  border-radius: 40px;\n"], ["\n  border-radius: 40px;\n"])));
var BottomTabBarWrapper = Styled__default["default"].View(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n\tflex-direction: row;\n  ", ";\n\t", ";\n    elevation: 2;\n\t", ";\n  ", ";\n\t", ";\n  ", "\n  padding-top: ", "px;\n  padding-horizontal: ", "px;\n  background-color: ", ";\n\t", ";\n\n  "], ["\n\tflex-direction: row;\n  ", ";\n\t", ";\n    elevation: 2;\n\t", ";\n  ", ";\n\t", ";\n  ", "\n  padding-top: ", "px;\n  padding-horizontal: ", "px;\n  background-color: ", ";\n\t", ";\n\n  "])), function (p) { return p.floating && !!p.forcedWidth && "width: ".concat(p.forcedWidth * 100, "%"); }, function (p) { return p.floating && floatingMarginHorizontal; }, function (p) { return p.floating && (p.topPositioned ? floatingMarginTop : floatingMarginBottom); }, function (p) { return p.topPositioned && floatingMarginTop; }, function (p) { return p.floating && floatingRoundCorner; }, function (p) { return p.topPositioned
    ? "padding-bottom: ".concat(p.bottomPadding, "px")
    : p.floating
        ? "padding-bottom: ".concat(p.bottomPadding, "px")
        : "padding-bottom: ".concat((reactNativeSafeAreaContext.initialWindowMetrics === null || reactNativeSafeAreaContext.initialWindowMetrics === void 0 ? void 0 : reactNativeSafeAreaContext.initialWindowMetrics.insets.bottom) + p.bottomPadding, "px"); }, function (p) { return p.topPadding; }, function (p) { return p.horizontalPadding; }, function (p) { return p.tabBarBackground; }, function (p) { return p.shadow && SHADOW; });
...
var TabButton = Styled__default["default"].TouchableOpacity(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n\tflex: 1;\n\tflex-direction: ", ";\n\tjustify-content: center;\n\talign-items: center;\n\tborder-radius: 100px;\n\tpadding-vertical: 10px;\n\tflex-grow: ", ";\n"], ["\n\tflex: 1;\n\tflex-direction: ", ";\n\tjustify-content: center;\n\talign-items: center;\n\tborder-radius: 100px;\n\tpadding-vertical: 10px;\n\tflex-grow: ", ";\n"])), function (p) {
...
var Label = Styled__default["default"](reactNative.Animated.Text)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n\tfontSize: ", "px;\n\tcolor: ", ";\n\tmargin-left: ", "px;\n"], ["\n\tfontSize: ", "px;\n\tcolor: ", ";\n\tmargin-left: ", "px;\n"])), function (p) {
...
var Dot = Styled__default["default"](reactNative.Animated.View)(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n\tposition: absolute;\n\ttop: ", "px;\n\twidth: ", "px;\n\theight: ", "px;\n\tborder-radius: ", "px;\n\tbackground-color: ", ";\n\tz-index: -1;\n"], ["\n\tposition: absolute;\n\ttop: ", "px;\n\twidth: ", "px;\n\theight: ", "px;\n\tborder-radius: ", "px;\n\tbackground-color: ", ";\n\tz-index: -1;\n"])), function (p) { return p.topPadding; }, function (p) { return p.width; }, function (p) { return p.height; }, function (p) { return p.dotCornerRadius; }, function (p) { return p.activeTabBackground; });
var SHADOW = Styled.css(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  shadow-color: #000000;\n  shadow-offset: 0px 5px;\n  shadow-opacity: 0.05;\n  elevation: 1;\n  shadow-radius: 20px;\n"], ["\n  shadow-color: #000000;\n  shadow-offset: 0px 5px;\n  shadow-opacity: 0.05;\n  elevation: 1;\n  shadow-radius: 20px;\n"])));
...
var TabBarElement = (function (_a) {
    ...
    var forcedWidth = floating ? appearance.forcedWidth : 1;
    var topPositioned = reactNative.Platform.OS === 'ios' ? appearance.topPositioned : undefined;
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        ...
        tabBarVisible && (React__default["default"].createElement(reactNative.View, { pointerEvents: "box-none", style: (floating || topPositioned) && overlayStyle },
            React__default["default"].createElement(BottomTabBarWrapper, { style: tabStyle, floating: floating, topPadding: topPadding, bottomPadding: bottomPadding, horizontalPadding: horizontalPadding, tabBarBackground: tabBarBackground, shadow: shadow, topPositioned: topPositioned, forcedWidth: forcedWidth },
